...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<mixlib-shellout>, ["~> 1.3"])
      ...
      s.add_runtime_dependency(%q<chef-zero>, [">= 1.7.2", "~> 1.7"])
      ...
      s.add_dependency(%q<mixlib-shellout>, ["~> 1.3"])
      ...
      s.add_dependency(%q<chef-zero>, [">= 1.7.2", "~> 1.7"])
